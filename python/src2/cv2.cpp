...
typedef std::vector<cmp::SadKeyPoint> vector_SadKeyPoint;
...
template<> struct pyopencvVecConverter<cmp::SadKeyPoint>
{
    static bool to(PyObject* obj, std::vector<cmp::SadKeyPoint>& value, const ArgInfo& info)
    {
        return pyopencv_to_generic_vec(obj, value, info);
    }

    static PyObject* from(const std::vector<cmp::SadKeyPoint>& value)
    {
        return pyopencv_from_generic_vec(value);
    }
};
...
PyMODINIT_FUNC PyInit_pysaddlepts();
PyObject* PyInit_pysaddlepts()
{
